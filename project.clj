(defproject io.github.solita-antti-mottonen/puumerkki "0.10.1-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.11.3"]
                 [pandect "1.0.2"]                          ;; SHA
                 ;[org.apache.pdfbox/pdfbox "3.0.2"] ;; no longer supported due to api changes required for 2.x
